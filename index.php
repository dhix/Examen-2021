...
<div class="d-flex flex-column justify-content-center align-items-center">
  ...
  <a href="https://manuel.pinto.dev" class="text-decoration-none">
    <h5 class="fw-light text-white m-0">— Pen by Manuel Pinto —</h5>
      ...
      <center><h2>FORMULARIO DE SEGUNDO EXAMEN PARCIAL DE DESAROLLO WEB</h2></center>
      <div class="container">
          <form class="d-flex" action="crud_productos.php" method="post">
            ...
            <div class="mb-3">
              ...
              <div class="mb-3">
                ...
                <input type="text" name="txt_descripcion" id="txt_descripcion" class="form-control" placeholder="Descripcion: COSA" required>
              </div>

              <div class="mb-3">
                <label for="lbl_precio_costo" class="form-label"><b>Precio Costo</b></label>
                <input type="number" step="0.01" name="txt_precio_costo" id="txt_precio_costo" class="form-control" placeholder="Costo: 10.2 " required>
              </div>

              <div class="mb-3">
                <label for="lbl_precio_venta" class="form-label"><b>Precio Venta</b></label>
                <input type="number" step="0.01" name="txt_precio_venta" id="txt_precio_venta" class="form-control" placeholder="Venta: 74.9" required>
              </div>

              <div class="mb-3">
                <label for="lbl_existencia" class="form-label"><b>Existencia</b></label>
                <input type="text" name="txt_existencia" id="txt_existencia" class="form-control" placeholder="Existencia: 100" required>
              </div>
              <div class="mb-3">
